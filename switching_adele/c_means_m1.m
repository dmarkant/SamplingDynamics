function [proba, probb, eta, etb] = c_means_m1(para,tau)

%---------------------------------------------



r12 = para(4); %attention switching from attribute 1 to attribute 2


r21=0; %attention switching from attribute 2 to attribute 1
...
mux2=para(2)-s2*delta*x;
        ...
        z2=(zeros(n/2,1));
        nn=(n/2-1)/2+1;
        z1(nn,1)=1; % Start with attribute 1 
        z=[z1;z2];
